...
------------------------------------------------
   ...
   SELECT ROWID,CIP_PER_AUTORIZA_CODIGO,CIP_PER_AUTORIZA_PUESTO,CIP_PER_AUTORIZA_OBSERVACIONES,CIP_PER_AUTORIZA_FE_INGRESO,CIP_PER_AUTORIZA_USUARIO,CIP_PER_AUTORIZA_FIRMA FROM CIP_PERSONA_AUTORIZA WHERE (faweqr)
