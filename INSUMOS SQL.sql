...
:Pla_Con_Contrato.Con_509   := '0509';
   ...
   SELECT COLUMN_NAME, data_type, data_length, nullable
	FROM ALL_TAB_COLUMNS 
	WHERE TABLE_NAME = 'COM_TID_TIPOS_DOCTOS' AND OWNER = 'ISYSEPQ';
   
   SELECT ROWID,PAR_CODCIA,PAR_FECHA,PAR_IMPUESIVA,PAR_TIPOMONEDA,PAR_NOMMONEDA,PAR_INICODMON,PAR_VALORVALE,PAR_EMISOLCOM,PAR_COTDESOLI,PAR_updsolcom,PAR_AUTSOLCOM,PAR_RECSOLCOM,PAR_ANUSOLCOM,PAR_EMIORDCOM,PAR_AUTORDCOM,PAR_RECORDCOM,PAR_ANUORDCOM,PAR_COTORDCOM,PAR_EMIVALCAJ,PAR_AUTVALCAJ,PAR_LIQCAJCHI,PAR_rec_valcaj,PAR_ANUVALCAJ,PAR_INGALMPAR,PAR_INGALMTOT,PAR_LIQDESERV,PAR_VALES,PAR_RESERVAAUT,PAR_RESERVAMAN,PAR_VALCONTRATO,PAR_LINEA_MEDICA,PAR_BODEGA_MEDICA,PAR_TRACOMPRA,PAR_SOLCOMPRA,PAR_ORDCOMPRA,PAR_NUMVALE,PAR_ETAENVIO,PAR_ETARECIBIDO,PAR_TIMER FROM COM_PAR_PARAMETROS_GENERALES WHERE (PAR_CODCIA=:1) and (fggdfgsd)
   
   
   SELECT ROWID,TID_CODIGO,TID_DESCRIPCION FROM COM_TID_TIPOS_DOCTOS WHERE (fasdfa)
...
SELECT * FROM RHEPQ.CAPACAPACITACION # Si
SELECT * FROM RHEPQ.CAPACURSO # Si
SELECT * FROM RHEPQ.CAPACURSODOCUMENTO # No
SELECT * FROM RHEPQ.CAPACURSOPROFESOR # No
SELECT * FROM RHEPQ.CAPACURSOPROFESOREXTERNO # No
SELECT * FROM RHEPQ.CAPADETALLECAPACITACION # Si
SELECT * FROM RHEPQ.CAPADETALLECAPACITACIONEXTERNO # Si
SELECT * FROM RHEPQ.CAPADOCUMENTO # Si
SELECT * FROM RHEPQ.CAPAFIRMA # Si
SELECT * FROM RHEPQ.CAPAFIRMADOCUMENTO # No
SELECT * FROM RHEPQ.CAPAPROFESOREXTERNO # Si
SELECT * FROM RHEPQ.CAPASALON # Si
SELECT * FROM RHEPQ.CAPASALONCAPACITACION # Si
SELECT * FROM RHEPQ.CAPATIPOCAPACITACION # Si
SELECT * FROM RHEPQ.CAPATIPODOCUMENTO # Si



SELECT * FROM RHEPQ.PLA_EMP_EMPLEADO pee 
SELECT * FROM RHEPQ.CapaProfesor

SELECT trigger_name, table_name, status
FROM ALL_TRIGGERS
WHERE LOWER(table_name) = LOWER('trCapaFirmaDocumento') 
AND LOWER(owner) = LOWER('rhepq') 

SELECT sequence_name
FROM ALL_SEQUENCES
WHERE LOWER(sequence_owner) = 'rhepq'
AND LOWER(sequence_name) = LOWER('capaDetalleCapaExternoSeq') 
	...
	create table RHEPQ.capaCursoProfesor(
		...
		constraint fkCursoProfesor FOREIGN key (idCurso) references RHEPQ.capaCurso(id),
		constraint fkCursoProfesor2 FOREIGN KEY (idPersona, codCia) references RHEPQ.PLA_EMP_EMPLEADO(EMP_CODIGO, EMP_CODCIA)
	);
...
--SELECT * FROM RHEPQ.PLA_EMP_EMPLEADO WHERE EMP_CODIGO = 17

CAPACAPACITACION # Si
CAPACURSO # Si
CAPACURSODOCUMENTO # No
CAPACURSOPROFESOR # No
CAPACURSOPROFESOREXTERNO # No
CAPADETALLECAPACITACION # Si
CAPADETALLECAPACITACIONEXTERNO # Si
CAPADOCUMENTO # Si
CAPAFIRMA # Si
CAPAFIRMADOCUMENTO # No
CAPAPROFESOREXTERNO # Si
CAPASALON # Si
CAPASALONCAPACITACION # Si
CAPATIPOCAPACITACION # Si
CAPATIPODOCUMENTO # Si
